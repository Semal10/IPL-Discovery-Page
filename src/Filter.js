...
const Filter = ({
  ...
  const [tempBattingPref, setTempBattingPref] = useState("");
  const [tempBowlingPref, setTempBowlingPref] = useState("");
  ...
  const handleSubmit = () => {
    setForcePage(0);
    setDate(tempDate);
    setBattingPref(tempBattingPref);
    setBowlingPref(tempBowlingPref);
  ...
  return (
    <div className="filter-side" style={styleObj}>
      ...
      <div className="filters">
        ...
        <div className="battingpref">
          <h2>Batting Preference</h2>
          <div className="radios">
            <div>
              <input
                ...
                name="batting"
                value="Left_Hand"
                onChange={(e) => setTempBattingPref(e.target.value)}
              />
              <label for="male">Left Hand</label>
            </div>
            <div>
              <input
                className="radio-button"
                ...
                onChange={(e) => setTempBattingPref(e.target.value)}
              />
              <label for="female">Right Hand</label>
            </div>
          </div>
        </div>
        <div className="bowlingpref">
          <h2>Bowling Preference</h2>
          <select
            value={tempBowlingPref}
            onChange={(e) => setTempBowlingPref(e.target.value)}
          >
